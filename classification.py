...
df = pd.read_csv(r'C:/Users/LENOVO/OneDrive/Desktop/AQI PREDICTOR/balanced_station_day_realtime.csv')
...
print(f'\n✅ Final Optimized Stacking Ensemble Performance:')
...
joblib.dump(stack_model, r'C:/Users/LENOVO/OneDrive/Desktop/AQI PREDICTOR/final_stack_model_optimized.pkl')
joblib.dump(le, r'C:/Users/LENOVO/OneDrive/Desktop/AQI PREDICTOR/label_encoder_station.pkl')
joblib.dump(scaler, r'C:/Users/LENOVO/OneDrive/Desktop/AQI PREDICTOR/scaler_station.pkl')

print("\n✅ Final optimized stacking model and encoders saved successfully.")
